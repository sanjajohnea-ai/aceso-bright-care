  ...
  return (
    ...
    >
      ...
      <div className="container relative z-10 pt-28 pb-32 md:pt-44 md:pb-36 px-5">
        ...
        >
          <h1 className="text-2xl md:text-5xl lg:text-6xl font-extrabold text-primary-foreground leading-[1.15] tracking-tight">
            Expert Medical Care.
            <span className="block mt-1 md:mt-2 bg-gradient-to-r from-primary-foreground to-primary-foreground/60 bg-clip-text text-transparent">
              Anytime, Anywhere.
            </span>
          </h1>

          <p className="text-sm md:text-lg text-primary-foreground/75 max-w-md leading-relaxed font-body">
          ...
          <div className="flex flex-wrap gap-3 md:gap-4 pt-1" role="group" aria-label="Get started actions">
