      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-10 md:mb-14">
        <div className="col-span-2 lg:col-span-1">
          ...
          <div className="flex flex-col sm:flex-row items-start gap-3">
            <a href="https://play.google.com/store" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-primary-foreground/10 transition-colors duration-200 text-sm font-medium bg-black hover:bg-black/80 text-white">
              <svg viewBox="0 0 24 24" className="w-5 h-5"><path d="M3.609 1.814L13.792 12 3.61 22.186a.996.996 0 0 1-.61-.92V2.734a1 1 0 0 1 .609-.92z" fill="#4285F4"/><path d="M14.499 12.707l2.302 2.302-10.937 6.333 8.635-8.635z" fill="#EA4335"/><path d="M17.698 9.508l2.302 2.302a1 1 0 0 1 0 1.38l-2.302 2.302L15.396 13l2.302-2.492z" fill="#FBBC04"/><path d="M5.864 2.658L16.8 8.99l-2.302 2.302-8.634-8.634z" fill="#34A853"/></svg>
              Google Play
            </a>
            <a href="https://apps.apple.com" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-primary-foreground/10 transition-colors duration-200 text-sm font-medium bg-black hover:bg-black/80 text-white">
